...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        //check from grid[0][0]
        if (grid[0][0]!='-'){
            if (grid[1][0]==grid[0][0] && grid[2][0]==grid[0][0]) {//left vertical
                result = grid[0][0] + " wins";
                return (result);
            }
            if (grid[0][1]==grid[0][0] && grid[0][2]==grid[0][0]) {//upper horizontal
                result = grid[0][0] + " wins";
                return (result);
            }
            if (grid[1][1]==grid[0][0] && grid[2][2]==grid[0][0]) {//main diagonal
                result = grid[0][0] + " wins";
                return (result);
            }
        }
        //check from grid[0][1]
        if (grid[0][1]!='-'){
            if (grid[1][1]==grid[0][1] && grid[2][1]==grid[0][1]) {//center vertical
        ...
        //check from grid[1][0]
        if (grid[1][0]!='-'){
            if (grid[1][1]==grid[1][0] && grid[1][2]==grid[1][0]) {//center horizontal
        ...
        //check from grid[2][0]
        if (grid[2][0]!='-'){
            if (grid[2][1]==grid[2][0] && grid[2][2]==grid[2][0]) {//bottom horizontal
        ...
        //check from grid[0][2]
        if (grid[0][2]!='-'){
            if (grid[1][2]==grid[0][2] && grid[2][2]==grid[0][2]) {//right vertical
                result = grid[0][2] + " wins";
                return (result);
            }
            if (grid[1][1]==grid[0][2] && grid[2][0]==grid[0][2]) {//counter diagonal
                result = grid[0][2] + " wins";
                return (result);
            }
        }
